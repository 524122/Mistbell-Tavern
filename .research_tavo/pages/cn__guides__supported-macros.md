URL: https://docs.tavoai.dev/cn/guides/supported-macros/
STATUS: 200
...
【输入框左下角】→【点击】→ 点击【宏助手】，找到对应的变量宏并点击自动填入输入框。
只需要把变量名和数值改成你想要的就行。
...
宏适合简单注入和非空条件判断。需要 else、比较、循环或变量运算时，请用 EJS 模板。
